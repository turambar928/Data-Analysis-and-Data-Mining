...
def explore_dataset(file_path, dataset_name):
    ...
    try:
        ...
        print(f"鉁?Successfully loaded {dataset_name}")
        ...
        print(f"鉁?Error loading {dataset_name}: {e}")
        return None
...
def main():
    ...
    if df1 is not None and df2 is not None:
        print("鉁?Both datasets loaded successfully")
        print("鉁?Proceed with data preprocessing and model development")
        print("鉁?Consider combining datasets if they have compatible structure")
        print("鉁?Identify the correct target variable for diabetes prediction")
    elif df1 is not None or df2 is not None:
        print("鈿?Only one dataset loaded successfully")
        print("鉁?Proceed with available dataset")
    else:
        print("鉁?Failed to load datasets - check file paths and formats")
